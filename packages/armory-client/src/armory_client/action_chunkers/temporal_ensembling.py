        ...
        with self._lock:
            ...
            for step in range(start_step, end_step + 1):
                ...
                for chunk_idx, chunk in enumerate(self._action_chunks):
                    chunk_start = chunk.action_index_start
                    chunk_end = chunk.action_index_start + len(chunk.actions) - 1
                ...
                if predictions:
                    ...
                    self._action_queue.append(
                        Action(
                            ...
                            index_in_chunk=step - action_chunk.action_index_start
                            if step >= action_chunk.action_index_start
                            else None,
                        )
                    )
